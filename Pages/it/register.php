  ...
  <body>
    ...
    <div class="container">
      <form class="form-signin" action="proses_login.php" method="post">
        ...
        <br> 
        <h2 class="form-signin-heading" align="center" style="color: #757575;">LOGIN INFOTANI</h2>
        ...
        <input type="text" id="email" name="email" class="form-control" placeholder="infotani@gmail.com" required autofocus>
        <br>
        <label for="password" class="sr-only">Kata Sandi</label>
        <input type="password" id="password" name="password" class="form-control" placeholder="Kata Sandi" required autofocus>
        <br>
        <label for="passwordConf" class="sr-only">Ulangi Kata Sandi</label>
