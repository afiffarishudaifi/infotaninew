            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $query = mysqli_query($koneksi, "SELECT ID_PESAN, ID_PERUSAHAAN, KTP, TANGGAL, JUMLAH_PESAN, TOTAL_BIAYA, STATUS_PESAN FROM pemesanan, pesan where pesan.ID_PESAN_STATUS=pemesanan.ID_PESAN_STATUS and KTP=$ktppetani");
                    //echo $query;
